...
class m170610_162817_oauth extends \yii\db\Migration
{
    ...
    public function up()
    {
        ...
        try {
            ...
            $this->createTable('{{%oauth_access_tokens}}', [
                ...
                'client_id' => Schema::TYPE_STRING . '(32) NOT NULL',
                'user_id' => Schema::TYPE_INTEGER . ' DEFAULT NULL',
                'expires' => Schema::TYPE_TIMESTAMP . "  DEFAULT CURRENT_TIMESTAMP NOT NULL",
                'scope' => Schema::TYPE_STRING . '(2000) DEFAULT NULL',
                $this->primaryKey('access_token'),
                $this->foreignKey('client_id','{{%oauth_clients}}','client_id','CASCADE'),
            ], $tableOptions);
